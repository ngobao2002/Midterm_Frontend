...
function loadingFolders() {
    ...
    document.getElementById("notify").innerHTML = "Choose your space and note your task. <br>If you don't have any space, create it.";
    ...
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4) {
            if (this.status == 200) {
                ...
                if (objects.length === 0) {
                    document.getElementById("table").style.display = "none";
                    document.getElementById("notify").innerHTML = "Unfortunately, no one willing to share their task with you";
                } else {
